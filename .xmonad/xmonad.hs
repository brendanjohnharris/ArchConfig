...
myStartupHook = do
    ...
    spawn ("sleep 2 && trayer --edge top --align center --widthtype request --padding 6 --SetDockType true --SetPartialStrut true --expand true --monitor 1 --transparent true --alpha 127 " ++ colorTrayer ++ " --height 22")
